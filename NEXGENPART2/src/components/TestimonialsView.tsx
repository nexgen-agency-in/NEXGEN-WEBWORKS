...
export default function TestimonialsView() {
  ...
  return (
    <section className="py-12 relative overflow-hidden" id="testimonials-faqs-section">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="mb-14" id="testimonials-block">
        ...
        <div id="delivered-websites-showcase" className="mb-14">
        ...
        <div id="agency-qa-block" className="max-w-4xl mx-auto">
          ...
          <p className="font-sans text-body-md text-on-surface-variant mb-6 text-center sm:text-left font-light leading-relaxed">
          ...
          <div className="mt-6 bg-gradient-to-r from-secondary-container/10 via-[#0a0a0c] to-secondary-container/10 border border-outline-variant/40 p-6 rounded-xl text-center">
