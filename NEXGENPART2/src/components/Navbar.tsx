    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-surface/35 backdrop-blur-[20px] border-b border-white/10 px-6 py-3 transition-all duration-300">
      <div className="max-w-7xl mx-auto flex justify-between items-center w-full">
        ...
        <div 
          ...
          id="brand-logo"
        >
          <div className="p-2.5 rounded-xl bg-black border border-white/20 text-white flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
            <svg
              viewBox="0 0 100 100"
              className="w-7 h-7 fill-current text-white"
              xmlns="http://www.w3.org/2000/svg"
            >
              <polygon points="25,28 25,75 35,65 35,48 62,75 72,75 25,28" />
              <polygon points="75,72 75,25 65,35 65,52 38,25 28,25 75,72" />
            </svg>
          </div>
