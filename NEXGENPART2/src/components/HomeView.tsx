...
import { ArrowRight, Code, Brush, Headphones, Mail, Hexagon, Sparkles, Cpu, CpuIcon, ShieldCheck, Server, Zap, Infinity } from 'lucide-react';
...
interface HomeViewProps {
  ...
  setSelectedClassification: (type: ProjectClassificationType) => void;
}

export default function HomeView({ setActiveTab, selectedClassification, setSelectedClassification }: HomeViewProps) {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* 1. HERO SECTION */}
      <section 
        className="flex flex-col justify-center px-6 md:px-12 max-w-7xl mx-auto w-full relative mb-10 md:mb-14 pt-6"
        id="hero-section"
      >
        <div className="flex flex-col items-center relative z-10 w-full max-w-5xl mx-auto">
          ...
          <div className="relative select-none w-full max-w-2xl sm:max-w-3xl mx-auto px-4 sm:px-6 mb-10 md:mb-12" id="hero-responsive-mockup-wrapper">
          ...
          <div className="flex flex-col items-center text-center max-w-4xl px-4 sm:px-6 w-full">
            ...
            <div 
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel mb-4 border border-[#8A2BE2]/30 shadow-[0_0_15px_rgba(138,43,226,0.15)] select-none hover:border-[#8A2BE2]/60 transition-all duration-300"
            ...
            {/* Giant Title */}
            <h1 
              className="font-display text-4xl sm:text-5xl md:text-7xl font-extrabold mb-4 leading-[1.1] tracking-tight text-white text-center"
              id="hero-title"
            >
              Next Generation <br />
            ...
            <p 
              className="font-sans text-body-lg text-on-surface-variant max-w-2xl mb-6 leading-relaxed font-light text-center"
              id="hero-description"
            >
      ...
      <section className="px-6 md:px-12 max-w-7xl mx-auto w-full mb-10 md:mb-14" id="trusted-by-strip">
        <div className="glass-panel py-5 px-6 rounded-xl border border-outline-variant/10 bg-[#070709]/40 w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-y-4 gap-x-6 items-center justify-items-center text-center">
            <div className="flex items-center gap-2.5 hover:text-white transition-colors duration-350 select-none">
              <span className="text-base">⚡</span>
              <span className="font-sans text-[11px] font-bold tracking-wider uppercase text-zinc-400">Modern React & Vite</span>
            </div>
            <div className="flex items-center gap-2.5 hover:text-white transition-colors duration-350 select-none">
              <span className="text-base">🔒</span>
              <span className="font-sans text-[11px] font-bold tracking-wider uppercase text-zinc-400">Security-Focused Development</span>
            </div>
            <div className="flex items-center gap-2.5 hover:text-white transition-colors duration-350 select-none">
              <span className="text-base">☁️</span>
              <span className="font-sans text-[11px] font-bold tracking-wider uppercase text-zinc-400">Cloud-Ready Architecture</span>
            </div>
            <div className="flex items-center gap-2.5 hover:text-white transition-colors duration-350 select-none">
              <span className="text-base">📱</span>
              <span className="font-sans text-[11px] font-bold tracking-wider uppercase text-zinc-400">Mobile Responsive Design</span>
            </div>
            <div className="flex items-center gap-2.5 hover:text-white transition-colors duration-350 select-none">
              <span className="text-base">🚀</span>
              <span className="font-sans text-[11px] font-bold tracking-wider uppercase text-zinc-400">Performance Optimized</span>
            </div>
            <div className="flex items-center gap-2.5 hover:text-white transition-colors duration-350 select-none">
              <span className="text-base">💳</span>
              <span className="font-sans text-[11px] font-bold tracking-wider uppercase text-zinc-400">Payment Integration Ready</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section 
        className="px-6 md:px-12 max-w-7xl mx-auto w-full mb-10 md:mb-14"
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-3">
          {STRATEGIST_FOUNDERS.map((founder, idx) => {
            const alignmentClass = 'translate-y-0';
      ...
      {/* 4. INTEGRATED CONTACT SECTION */}
      <section className="w-full relative py-6 md:py-12 border-t border-outline-variant/10">
        <ContactView 
